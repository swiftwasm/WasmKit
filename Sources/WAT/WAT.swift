...
///
/// - Parameters:
///   - stream: The raw bytes stream of a WebAssembly binary module, either `StaticByteStreamSource` or `FileHandleStreamSource`.
...
/// print(wat)
/// ```
public func wasm2wat<Source: ByteStreamSource>(
    _ stream: Source,
    features: WasmFeatureSet = .default
) throws -> String {
