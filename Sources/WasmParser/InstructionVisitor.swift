...
public enum Instruction: Equatable {
    ...
    case `atomicFence`
    case `i32AtomicLoad`(memarg: MemArg)
    case `i64AtomicLoad`(memarg: MemArg)
    case `i32AtomicLoad8U`(memarg: MemArg)
    case `i32AtomicLoad16U`(memarg: MemArg)
    case `i64AtomicLoad8U`(memarg: MemArg)
    case `i64AtomicLoad16U`(memarg: MemArg)
    case `i64AtomicLoad32U`(memarg: MemArg)
    case `i32AtomicStore`(memarg: MemArg)
    case `i64AtomicStore`(memarg: MemArg)
    case `i32AtomicStore8`(memarg: MemArg)
    case `i32AtomicStore16`(memarg: MemArg)
    case `i64AtomicStore8`(memarg: MemArg)
    case `i64AtomicStore16`(memarg: MemArg)
    case `i64AtomicStore32`(memarg: MemArg)
...
extension AnyInstructionVisitor {
    ...
    public mutating func visitI32AtomicLoad(memarg: MemArg) throws { return try self.visit(.i32AtomicLoad(memarg: memarg)) }
    public mutating func visitI64AtomicLoad(memarg: MemArg) throws { return try self.visit(.i64AtomicLoad(memarg: memarg)) }
    public mutating func visitI32AtomicLoad8U(memarg: MemArg) throws { return try self.visit(.i32AtomicLoad8U(memarg: memarg)) }
    public mutating func visitI32AtomicLoad16U(memarg: MemArg) throws { return try self.visit(.i32AtomicLoad16U(memarg: memarg)) }
    public mutating func visitI64AtomicLoad8U(memarg: MemArg) throws { return try self.visit(.i64AtomicLoad8U(memarg: memarg)) }
    public mutating func visitI64AtomicLoad16U(memarg: MemArg) throws { return try self.visit(.i64AtomicLoad16U(memarg: memarg)) }
    public mutating func visitI64AtomicLoad32U(memarg: MemArg) throws { return try self.visit(.i64AtomicLoad32U(memarg: memarg)) }
    public mutating func visitI32AtomicStore(memarg: MemArg) throws { return try self.visit(.i32AtomicStore(memarg: memarg)) }
    public mutating func visitI64AtomicStore(memarg: MemArg) throws { return try self.visit(.i64AtomicStore(memarg: memarg)) }
    public mutating func visitI32AtomicStore8(memarg: MemArg) throws { return try self.visit(.i32AtomicStore8(memarg: memarg)) }
    public mutating func visitI32AtomicStore16(memarg: MemArg) throws { return try self.visit(.i32AtomicStore16(memarg: memarg)) }
    public mutating func visitI64AtomicStore8(memarg: MemArg) throws { return try self.visit(.i64AtomicStore8(memarg: memarg)) }
    public mutating func visitI64AtomicStore16(memarg: MemArg) throws { return try self.visit(.i64AtomicStore16(memarg: memarg)) }
    public mutating func visitI64AtomicStore32(memarg: MemArg) throws { return try self.visit(.i64AtomicStore32(memarg: memarg)) }
...
public struct InstructionTracingVisitor<V: InstructionVisitor>: InstructionVisitor {
    ...
    public mutating func visitMemoryAtomicNotify(memarg: MemArg) throws {
       trace(.memoryAtomicNotify(memarg: memarg))
       return try visitor.visitMemoryAtomicNotify(memarg: memarg)
    }
    public mutating func visitMemoryAtomicWait32(memarg: MemArg) throws {
       trace(.memoryAtomicWait32(memarg: memarg))
       return try visitor.visitMemoryAtomicWait32(memarg: memarg)
    }
    public mutating func visitMemoryAtomicWait64(memarg: MemArg) throws {
       trace(.memoryAtomicWait64(memarg: memarg))
       return try visitor.visitMemoryAtomicWait64(memarg: memarg)
    }
    public mutating func visitAtomicFence() throws {
       trace(.atomicFence)
       return try visitor.visitAtomicFence()
    }
    public mutating func visitI32AtomicLoad(memarg: MemArg) throws {
       trace(.i32AtomicLoad(memarg: memarg))
       return try visitor.visitI32AtomicLoad(memarg: memarg)
    }
    public mutating func visitI64AtomicLoad(memarg: MemArg) throws {
       trace(.i64AtomicLoad(memarg: memarg))
       return try visitor.visitI64AtomicLoad(memarg: memarg)
    }
    public mutating func visitI32AtomicLoad8U(memarg: MemArg) throws {
       trace(.i32AtomicLoad8U(memarg: memarg))
       return try visitor.visitI32AtomicLoad8U(memarg: memarg)
    }
    public mutating func visitI32AtomicLoad16U(memarg: MemArg) throws {
       trace(.i32AtomicLoad16U(memarg: memarg))
       return try visitor.visitI32AtomicLoad16U(memarg: memarg)
    }
    public mutating func visitI64AtomicLoad8U(memarg: MemArg) throws {
       trace(.i64AtomicLoad8U(memarg: memarg))
       return try visitor.visitI64AtomicLoad8U(memarg: memarg)
    }
    public mutating func visitI64AtomicLoad16U(memarg: MemArg) throws {
       trace(.i64AtomicLoad16U(memarg: memarg))
       return try visitor.visitI64AtomicLoad16U(memarg: memarg)
    }
    public mutating func visitI64AtomicLoad32U(memarg: MemArg) throws {
       trace(.i64AtomicLoad32U(memarg: memarg))
       return try visitor.visitI64AtomicLoad32U(memarg: memarg)
    }
    public mutating func visitI32AtomicStore(memarg: MemArg) throws {
       trace(.i32AtomicStore(memarg: memarg))
       return try visitor.visitI32AtomicStore(memarg: memarg)
    }
    public mutating func visitI64AtomicStore(memarg: MemArg) throws {
       trace(.i64AtomicStore(memarg: memarg))
       return try visitor.visitI64AtomicStore(memarg: memarg)
    }
    public mutating func visitI32AtomicStore8(memarg: MemArg) throws {
       trace(.i32AtomicStore8(memarg: memarg))
       return try visitor.visitI32AtomicStore8(memarg: memarg)
    }
    public mutating func visitI32AtomicStore16(memarg: MemArg) throws {
       trace(.i32AtomicStore16(memarg: memarg))
       return try visitor.visitI32AtomicStore16(memarg: memarg)
    }
    public mutating func visitI64AtomicStore8(memarg: MemArg) throws {
       trace(.i64AtomicStore8(memarg: memarg))
       return try visitor.visitI64AtomicStore8(memarg: memarg)
    }
    public mutating func visitI64AtomicStore16(memarg: MemArg) throws {
       trace(.i64AtomicStore16(memarg: memarg))
       return try visitor.visitI64AtomicStore16(memarg: memarg)
    }
    public mutating func visitI64AtomicStore32(memarg: MemArg) throws {
       trace(.i64AtomicStore32(memarg: memarg))
       return try visitor.visitI64AtomicStore32(memarg: memarg)
    }
    public mutating func visitI32AtomicRmwAdd(memarg: MemArg) throws {
       trace(.i32AtomicRmwAdd(memarg: memarg))
       return try visitor.visitI32AtomicRmwAdd(memarg: memarg)
    }
    public mutating func visitI64AtomicRmwAdd(memarg: MemArg) throws {
       trace(.i64AtomicRmwAdd(memarg: memarg))
       return try visitor.visitI64AtomicRmwAdd(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw8AddU(memarg: MemArg) throws {
       trace(.i32AtomicRmw8AddU(memarg: memarg))
       return try visitor.visitI32AtomicRmw8AddU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw16AddU(memarg: MemArg) throws {
       trace(.i32AtomicRmw16AddU(memarg: memarg))
       return try visitor.visitI32AtomicRmw16AddU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw8AddU(memarg: MemArg) throws {
       trace(.i64AtomicRmw8AddU(memarg: memarg))
       return try visitor.visitI64AtomicRmw8AddU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw16AddU(memarg: MemArg) throws {
       trace(.i64AtomicRmw16AddU(memarg: memarg))
       return try visitor.visitI64AtomicRmw16AddU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw32AddU(memarg: MemArg) throws {
       trace(.i64AtomicRmw32AddU(memarg: memarg))
       return try visitor.visitI64AtomicRmw32AddU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmwSub(memarg: MemArg) throws {
       trace(.i32AtomicRmwSub(memarg: memarg))
       return try visitor.visitI32AtomicRmwSub(memarg: memarg)
    }
    public mutating func visitI64AtomicRmwSub(memarg: MemArg) throws {
       trace(.i64AtomicRmwSub(memarg: memarg))
       return try visitor.visitI64AtomicRmwSub(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw8SubU(memarg: MemArg) throws {
       trace(.i32AtomicRmw8SubU(memarg: memarg))
       return try visitor.visitI32AtomicRmw8SubU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw16SubU(memarg: MemArg) throws {
       trace(.i32AtomicRmw16SubU(memarg: memarg))
       return try visitor.visitI32AtomicRmw16SubU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw8SubU(memarg: MemArg) throws {
       trace(.i64AtomicRmw8SubU(memarg: memarg))
       return try visitor.visitI64AtomicRmw8SubU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw16SubU(memarg: MemArg) throws {
       trace(.i64AtomicRmw16SubU(memarg: memarg))
       return try visitor.visitI64AtomicRmw16SubU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw32SubU(memarg: MemArg) throws {
       trace(.i64AtomicRmw32SubU(memarg: memarg))
       return try visitor.visitI64AtomicRmw32SubU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmwAnd(memarg: MemArg) throws {
       trace(.i32AtomicRmwAnd(memarg: memarg))
       return try visitor.visitI32AtomicRmwAnd(memarg: memarg)
    }
    public mutating func visitI64AtomicRmwAnd(memarg: MemArg) throws {
       trace(.i64AtomicRmwAnd(memarg: memarg))
       return try visitor.visitI64AtomicRmwAnd(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw8AndU(memarg: MemArg) throws {
       trace(.i32AtomicRmw8AndU(memarg: memarg))
       return try visitor.visitI32AtomicRmw8AndU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw16AndU(memarg: MemArg) throws {
       trace(.i32AtomicRmw16AndU(memarg: memarg))
       return try visitor.visitI32AtomicRmw16AndU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw8AndU(memarg: MemArg) throws {
       trace(.i64AtomicRmw8AndU(memarg: memarg))
       return try visitor.visitI64AtomicRmw8AndU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw16AndU(memarg: MemArg) throws {
       trace(.i64AtomicRmw16AndU(memarg: memarg))
       return try visitor.visitI64AtomicRmw16AndU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw32AndU(memarg: MemArg) throws {
       trace(.i64AtomicRmw32AndU(memarg: memarg))
       return try visitor.visitI64AtomicRmw32AndU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmwOr(memarg: MemArg) throws {
       trace(.i32AtomicRmwOr(memarg: memarg))
       return try visitor.visitI32AtomicRmwOr(memarg: memarg)
    }
    public mutating func visitI64AtomicRmwOr(memarg: MemArg) throws {
       trace(.i64AtomicRmwOr(memarg: memarg))
       return try visitor.visitI64AtomicRmwOr(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw8OrU(memarg: MemArg) throws {
       trace(.i32AtomicRmw8OrU(memarg: memarg))
       return try visitor.visitI32AtomicRmw8OrU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw16OrU(memarg: MemArg) throws {
       trace(.i32AtomicRmw16OrU(memarg: memarg))
       return try visitor.visitI32AtomicRmw16OrU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw8OrU(memarg: MemArg) throws {
       trace(.i64AtomicRmw8OrU(memarg: memarg))
       return try visitor.visitI64AtomicRmw8OrU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw16OrU(memarg: MemArg) throws {
       trace(.i64AtomicRmw16OrU(memarg: memarg))
       return try visitor.visitI64AtomicRmw16OrU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw32OrU(memarg: MemArg) throws {
       trace(.i64AtomicRmw32OrU(memarg: memarg))
       return try visitor.visitI64AtomicRmw32OrU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmwXor(memarg: MemArg) throws {
       trace(.i32AtomicRmwXor(memarg: memarg))
       return try visitor.visitI32AtomicRmwXor(memarg: memarg)
    }
    public mutating func visitI64AtomicRmwXor(memarg: MemArg) throws {
       trace(.i64AtomicRmwXor(memarg: memarg))
       return try visitor.visitI64AtomicRmwXor(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw8XorU(memarg: MemArg) throws {
       trace(.i32AtomicRmw8XorU(memarg: memarg))
       return try visitor.visitI32AtomicRmw8XorU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw16XorU(memarg: MemArg) throws {
       trace(.i32AtomicRmw16XorU(memarg: memarg))
       return try visitor.visitI32AtomicRmw16XorU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw8XorU(memarg: MemArg) throws {
       trace(.i64AtomicRmw8XorU(memarg: memarg))
       return try visitor.visitI64AtomicRmw8XorU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw16XorU(memarg: MemArg) throws {
       trace(.i64AtomicRmw16XorU(memarg: memarg))
       return try visitor.visitI64AtomicRmw16XorU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw32XorU(memarg: MemArg) throws {
       trace(.i64AtomicRmw32XorU(memarg: memarg))
       return try visitor.visitI64AtomicRmw32XorU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmwXchg(memarg: MemArg) throws {
       trace(.i32AtomicRmwXchg(memarg: memarg))
       return try visitor.visitI32AtomicRmwXchg(memarg: memarg)
    }
    public mutating func visitI64AtomicRmwXchg(memarg: MemArg) throws {
       trace(.i64AtomicRmwXchg(memarg: memarg))
       return try visitor.visitI64AtomicRmwXchg(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw8XchgU(memarg: MemArg) throws {
       trace(.i32AtomicRmw8XchgU(memarg: memarg))
       return try visitor.visitI32AtomicRmw8XchgU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw16XchgU(memarg: MemArg) throws {
       trace(.i32AtomicRmw16XchgU(memarg: memarg))
       return try visitor.visitI32AtomicRmw16XchgU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw8XchgU(memarg: MemArg) throws {
       trace(.i64AtomicRmw8XchgU(memarg: memarg))
       return try visitor.visitI64AtomicRmw8XchgU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw16XchgU(memarg: MemArg) throws {
       trace(.i64AtomicRmw16XchgU(memarg: memarg))
       return try visitor.visitI64AtomicRmw16XchgU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw32XchgU(memarg: MemArg) throws {
       trace(.i64AtomicRmw32XchgU(memarg: memarg))
       return try visitor.visitI64AtomicRmw32XchgU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmwCmpxchg(memarg: MemArg) throws {
       trace(.i32AtomicRmwCmpxchg(memarg: memarg))
       return try visitor.visitI32AtomicRmwCmpxchg(memarg: memarg)
    }
    public mutating func visitI64AtomicRmwCmpxchg(memarg: MemArg) throws {
       trace(.i64AtomicRmwCmpxchg(memarg: memarg))
       return try visitor.visitI64AtomicRmwCmpxchg(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw8CmpxchgU(memarg: MemArg) throws {
       trace(.i32AtomicRmw8CmpxchgU(memarg: memarg))
       return try visitor.visitI32AtomicRmw8CmpxchgU(memarg: memarg)
    }
    public mutating func visitI32AtomicRmw16CmpxchgU(memarg: MemArg) throws {
       trace(.i32AtomicRmw16CmpxchgU(memarg: memarg))
       return try visitor.visitI32AtomicRmw16CmpxchgU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw8CmpxchgU(memarg: MemArg) throws {
       trace(.i64AtomicRmw8CmpxchgU(memarg: memarg))
       return try visitor.visitI64AtomicRmw8CmpxchgU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw16CmpxchgU(memarg: MemArg) throws {
       trace(.i64AtomicRmw16CmpxchgU(memarg: memarg))
       return try visitor.visitI64AtomicRmw16CmpxchgU(memarg: memarg)
    }
    public mutating func visitI64AtomicRmw32CmpxchgU(memarg: MemArg) throws {
       trace(.i64AtomicRmw32CmpxchgU(memarg: memarg))
       return try visitor.visitI64AtomicRmw32CmpxchgU(memarg: memarg)
    }
}
...
extension InstructionVisitor {
    ...
    public mutating func visit(_ instruction: Instruction) throws {
        ...
        case let .i32Load(memarg): return try visitI32Load(memarg: memarg)
        case let .i64Load(memarg): return try visitI64Load(memarg: memarg)
        case let .f32Load(memarg): return try visitF32Load(memarg: memarg)
        case let .f64Load(memarg): return try visitF64Load(memarg: memarg)
        case let .i32Load8S(memarg): return try visitI32Load8S(memarg: memarg)
        case let .i32Load8U(memarg): return try visitI32Load8U(memarg: memarg)
        case let .i32Load16S(memarg): return try visitI32Load16S(memarg: memarg)
        case let .i32Load16U(memarg): return try visitI32Load16U(memarg: memarg)
        case let .i64Load8S(memarg): return try visitI64Load8S(memarg: memarg)
        case let .i64Load8U(memarg): return try visitI64Load8U(memarg: memarg)
        case let .i64Load16S(memarg): return try visitI64Load16S(memarg: memarg)
        case let .i64Load16U(memarg): return try visitI64Load16U(memarg: memarg)
        case let .i64Load32S(memarg): return try visitI64Load32S(memarg: memarg)
        case let .i64Load32U(memarg): return try visitI64Load32U(memarg: memarg)
        ...
        case let .i32AtomicLoad(memarg): return try visitI32AtomicLoad(memarg: memarg)
        case let .i64AtomicLoad(memarg): return try visitI64AtomicLoad(memarg: memarg)
        case let .i32AtomicLoad8U(memarg): return try visitI32AtomicLoad8U(memarg: memarg)
        case let .i32AtomicLoad16U(memarg): return try visitI32AtomicLoad16U(memarg: memarg)
        case let .i64AtomicLoad8U(memarg): return try visitI64AtomicLoad8U(memarg: memarg)
        case let .i64AtomicLoad16U(memarg): return try visitI64AtomicLoad16U(memarg: memarg)
        case let .i64AtomicLoad32U(memarg): return try visitI64AtomicLoad32U(memarg: memarg)
        case let .i32AtomicStore(memarg): return try visitI32AtomicStore(memarg: memarg)
        case let .i64AtomicStore(memarg): return try visitI64AtomicStore(memarg: memarg)
        case let .i32AtomicStore8(memarg): return try visitI32AtomicStore8(memarg: memarg)
        case let .i32AtomicStore16(memarg): return try visitI32AtomicStore16(memarg: memarg)
        case let .i64AtomicStore8(memarg): return try visitI64AtomicStore8(memarg: memarg)
        case let .i64AtomicStore16(memarg): return try visitI64AtomicStore16(memarg: memarg)
        case let .i64AtomicStore32(memarg): return try visitI64AtomicStore32(memarg: memarg)
