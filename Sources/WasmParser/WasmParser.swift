...
extension Parser {
    ...
    func doParseInstruction<V: InstructionVisitor>(code: InstructionCode, visitor v: inout V) throws {
        ...
        case ._0xfe:
            let codeSuffix: UInt32 = try parseUnsigned()
            switch codeSuffix {
            case 0x00: return try v.visitMemoryAtomicNotify(memarg: try parseMemarg())
            case 0x01: return try v.visitMemoryAtomicWait32(memarg: try parseMemarg())
            case 0x02: return try v.visitMemoryAtomicWait64(memarg: try parseMemarg())
            case 0x03: return try v.visitAtomicFence()
            case 0x10: return try v.visitI32AtomicLoad(memarg: try parseMemarg())
            case 0x11: return try v.visitI64AtomicLoad(memarg: try parseMemarg())
            case 0x12: return try v.visitI32AtomicLoad8U(memarg: try parseMemarg())
            case 0x13: return try v.visitI32AtomicLoad16U(memarg: try parseMemarg())
            case 0x14: return try v.visitI64AtomicLoad8U(memarg: try parseMemarg())
            case 0x15: return try v.visitI64AtomicLoad16U(memarg: try parseMemarg())
            case 0x16: return try v.visitI64AtomicLoad32U(memarg: try parseMemarg())
            case 0x17: return try v.visitI32AtomicStore(memarg: try parseMemarg())
            case 0x18: return try v.visitI64AtomicStore(memarg: try parseMemarg())
            case 0x19: return try v.visitI32AtomicStore8(memarg: try parseMemarg())
            case 0x1A: return try v.visitI32AtomicStore16(memarg: try parseMemarg())
            case 0x1B: return try v.visitI64AtomicStore8(memarg: try parseMemarg())
            case 0x1C: return try v.visitI64AtomicStore16(memarg: try parseMemarg())
            case 0x1D: return try v.visitI64AtomicStore32(memarg: try parseMemarg())
            case 0x1E: return try v.visitI32AtomicRmwAdd(memarg: try parseMemarg())
            case 0x1F: return try v.visitI64AtomicRmwAdd(memarg: try parseMemarg())
            case 0x20: return try v.visitI32AtomicRmw8AddU(memarg: try parseMemarg())
            case 0x21: return try v.visitI32AtomicRmw16AddU(memarg: try parseMemarg())
            case 0x22: return try v.visitI64AtomicRmw8AddU(memarg: try parseMemarg())
            case 0x23: return try v.visitI64AtomicRmw16AddU(memarg: try parseMemarg())
            case 0x24: return try v.visitI64AtomicRmw32AddU(memarg: try parseMemarg())
            case 0x25: return try v.visitI32AtomicRmwSub(memarg: try parseMemarg())
            case 0x26: return try v.visitI64AtomicRmwSub(memarg: try parseMemarg())
            case 0x27: return try v.visitI32AtomicRmw8SubU(memarg: try parseMemarg())
            case 0x28: return try v.visitI32AtomicRmw16SubU(memarg: try parseMemarg())
            case 0x29: return try v.visitI64AtomicRmw8SubU(memarg: try parseMemarg())
            case 0x2A: return try v.visitI64AtomicRmw16SubU(memarg: try parseMemarg())
            case 0x2B: return try v.visitI64AtomicRmw32SubU(memarg: try parseMemarg())
            case 0x2C: return try v.visitI32AtomicRmwAnd(memarg: try parseMemarg())
            case 0x2D: return try v.visitI64AtomicRmwAnd(memarg: try parseMemarg())
            case 0x2E: return try v.visitI32AtomicRmw8AndU(memarg: try parseMemarg())
            case 0x2F: return try v.visitI32AtomicRmw16AndU(memarg: try parseMemarg())
            case 0x30: return try v.visitI64AtomicRmw8AndU(memarg: try parseMemarg())
            case 0x31: return try v.visitI64AtomicRmw16AndU(memarg: try parseMemarg())
            case 0x32: return try v.visitI64AtomicRmw32AndU(memarg: try parseMemarg())
            case 0x33: return try v.visitI32AtomicRmwOr(memarg: try parseMemarg())
            case 0x34: return try v.visitI64AtomicRmwOr(memarg: try parseMemarg())
            case 0x35: return try v.visitI32AtomicRmw8OrU(memarg: try parseMemarg())
            case 0x36: return try v.visitI32AtomicRmw16OrU(memarg: try parseMemarg())
            case 0x37: return try v.visitI64AtomicRmw8OrU(memarg: try parseMemarg())
            case 0x38: return try v.visitI64AtomicRmw16OrU(memarg: try parseMemarg())
            case 0x39: return try v.visitI64AtomicRmw32OrU(memarg: try parseMemarg())
            case 0x3A: return try v.visitI32AtomicRmwXor(memarg: try parseMemarg())
            case 0x3B: return try v.visitI64AtomicRmwXor(memarg: try parseMemarg())
            case 0x3C: return try v.visitI32AtomicRmw8XorU(memarg: try parseMemarg())
            case 0x3D: return try v.visitI32AtomicRmw16XorU(memarg: try parseMemarg())
            case 0x3E: return try v.visitI64AtomicRmw8XorU(memarg: try parseMemarg())
            case 0x3F: return try v.visitI64AtomicRmw16XorU(memarg: try parseMemarg())
            case 0x40: return try v.visitI64AtomicRmw32XorU(memarg: try parseMemarg())
            case 0x41: return try v.visitI32AtomicRmwXchg(memarg: try parseMemarg())
            case 0x42: return try v.visitI64AtomicRmwXchg(memarg: try parseMemarg())
            case 0x43: return try v.visitI32AtomicRmw8XchgU(memarg: try parseMemarg())
            case 0x44: return try v.visitI32AtomicRmw16XchgU(memarg: try parseMemarg())
            case 0x45: return try v.visitI64AtomicRmw8XchgU(memarg: try parseMemarg())
            case 0x46: return try v.visitI64AtomicRmw16XchgU(memarg: try parseMemarg())
            case 0x47: return try v.visitI64AtomicRmw32XchgU(memarg: try parseMemarg())
            case 0x48: return try v.visitI32AtomicRmwCmpxchg(memarg: try parseMemarg())
            case 0x49: return try v.visitI64AtomicRmwCmpxchg(memarg: try parseMemarg())
            case 0x4A: return try v.visitI32AtomicRmw8CmpxchgU(memarg: try parseMemarg())
            case 0x4B: return try v.visitI32AtomicRmw16CmpxchgU(memarg: try parseMemarg())
            case 0x4C: return try v.visitI64AtomicRmw8CmpxchgU(memarg: try parseMemarg())
            case 0x4D: return try v.visitI64AtomicRmw16CmpxchgU(memarg: try parseMemarg())
            case 0x4E: return try v.visitI64AtomicRmw32CmpxchgU(memarg: try parseMemarg())
            default:
                throw WasmParserError.unimplementedInstruction(code.rawValue, suffix: codeSuffix)
            }
        }
