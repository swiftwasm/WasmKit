...
extension Execution {
    ...
    mutating func tableSet(sp: Sp, tableSetOperand: Instruction.TableSetOperand) throws {
        let runtime = runtime.value
        let table = getTable(tableSetOperand.tableIndex, sp: sp, store: runtime.store)
    ...
    mutating func tableSize(sp: Sp, tableSizeOperand: Instruction.TableSizeOperand) {
        let runtime = runtime.value
        let table = getTable(tableSizeOperand.tableIndex, sp: sp, store: runtime.store)
    ...
    mutating func tableGrow(sp: Sp, tableGrowOperand: Instruction.TableGrowOperand) throws {
        let runtime = runtime.value
        let table = getTable(tableGrowOperand.tableIndex, sp: sp, store: runtime.store)
    ...
    mutating func tableFill(sp: Sp, tableFillOperand: Instruction.TableFillOperand) throws {
        let runtime = runtime.value
        let table = getTable(tableFillOperand.tableIndex, sp: sp, store: runtime.store)
    ...
    mutating func tableElementDrop(sp: Sp, tableElementDropOperand: Instruction.TableElementDropOperand) {
        let segment = currentInstance(sp: sp).elementSegments[Int(tableElementDropOperand)]
