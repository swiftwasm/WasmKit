...
extension Execution {
    ...
    mutating func doExecute(_ opcode: OpcodeID, sp: inout Sp, pc: inout Pc, md: inout Md, ms: inout Ms) throws -> CodeSlot {
        ...
        case 9: return try self.execute_unreachable(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 10: return self.execute_nop(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 11: return self.execute_br(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 12: return self.execute_brIf(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 13: return self.execute_brIfNot(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 14: return self.execute_brTable(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 15: return self.execute__return(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 16: return try self.execute_endOfExecution(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 17: return try self.execute_i32Load(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 18: return try self.execute_i64Load(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 19: return try self.execute_f32Load(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 20: return try self.execute_f64Load(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 21: return try self.execute_i32Load8S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 22: return try self.execute_i32Load8U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 23: return try self.execute_i32Load16S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 24: return try self.execute_i32Load16U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 25: return try self.execute_i64Load8S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 26: return try self.execute_i64Load8U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 27: return try self.execute_i64Load16S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 28: return try self.execute_i64Load16U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 29: return try self.execute_i64Load32S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 30: return try self.execute_i64Load32U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 31: return try self.execute_i32Store(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 32: return try self.execute_i64Store(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 33: return try self.execute_f32Store(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 34: return try self.execute_f64Store(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 35: return try self.execute_i32Store8(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 36: return try self.execute_i32Store16(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 37: return try self.execute_i64Store8(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 38: return try self.execute_i64Store16(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 39: return try self.execute_i64Store32(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 40: return self.execute_memorySize(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 41: return try self.execute_memoryGrow(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 42: return try self.execute_memoryInit(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 43: return self.execute_memoryDataDrop(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 44: return try self.execute_memoryCopy(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 45: return try self.execute_memoryFill(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 46: return self.execute_const32(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 47: return self.execute_const64(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 48: return self.execute_i32Add(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 49: return self.execute_i64Add(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 50: return self.execute_i32Sub(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 51: return self.execute_i64Sub(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 52: return self.execute_i32Mul(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 53: return self.execute_i64Mul(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 54: return self.execute_i32And(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 55: return self.execute_i64And(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 56: return self.execute_i32Or(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 57: return self.execute_i64Or(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 58: return self.execute_i32Xor(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 59: return self.execute_i64Xor(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 60: return self.execute_i32Shl(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 61: return self.execute_i64Shl(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 62: return self.execute_i32ShrS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 63: return self.execute_i64ShrS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 64: return self.execute_i32ShrU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 65: return self.execute_i64ShrU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 66: return self.execute_i32Rotl(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 67: return self.execute_i64Rotl(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 68: return self.execute_i32Rotr(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 69: return self.execute_i64Rotr(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 70: return try self.execute_i32DivS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 71: return try self.execute_i64DivS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 72: return try self.execute_i32DivU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 73: return try self.execute_i64DivU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 74: return try self.execute_i32RemS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 75: return try self.execute_i64RemS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 76: return try self.execute_i32RemU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 77: return try self.execute_i64RemU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 78: return self.execute_i32Eq(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 79: return self.execute_i64Eq(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 80: return self.execute_i32Ne(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 81: return self.execute_i64Ne(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 82: return self.execute_i32LtS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 83: return self.execute_i64LtS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 84: return self.execute_i32LtU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 85: return self.execute_i64LtU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 86: return self.execute_i32GtS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 87: return self.execute_i64GtS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 88: return self.execute_i32GtU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 89: return self.execute_i64GtU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 90: return self.execute_i32LeS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 91: return self.execute_i64LeS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 92: return self.execute_i32LeU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 93: return self.execute_i64LeU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 94: return self.execute_i32GeS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 95: return self.execute_i64GeS(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 96: return self.execute_i32GeU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 97: return self.execute_i64GeU(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 98: return self.execute_i32Clz(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 99: return self.execute_i64Clz(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 100: return self.execute_i32Ctz(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 101: return self.execute_i64Ctz(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 102: return self.execute_i32Popcnt(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 103: return self.execute_i64Popcnt(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 104: return self.execute_i32Eqz(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 105: return self.execute_i64Eqz(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 106: return self.execute_i32WrapI64(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 107: return self.execute_i64ExtendI32S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 108: return self.execute_i64ExtendI32U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 109: return self.execute_i32Extend8S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 110: return self.execute_i64Extend8S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 111: return self.execute_i32Extend16S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 112: return self.execute_i64Extend16S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 113: return self.execute_i64Extend32S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 114: return try self.execute_i32TruncF32S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 115: return try self.execute_i32TruncF32U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 116: return try self.execute_i32TruncSatF32S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 117: return try self.execute_i32TruncSatF32U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 118: return try self.execute_i32TruncF64S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 119: return try self.execute_i32TruncF64U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 120: return try self.execute_i32TruncSatF64S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 121: return try self.execute_i32TruncSatF64U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 122: return try self.execute_i64TruncF32S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 123: return try self.execute_i64TruncF32U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 124: return try self.execute_i64TruncSatF32S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 125: return try self.execute_i64TruncSatF32U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 126: return try self.execute_i64TruncF64S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 127: return try self.execute_i64TruncF64U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 128: return try self.execute_i64TruncSatF64S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 129: return try self.execute_i64TruncSatF64U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 130: return self.execute_f32ConvertI32S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 131: return self.execute_f32ConvertI32U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 132: return self.execute_f32ConvertI64S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 133: return self.execute_f32ConvertI64U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 134: return self.execute_f64ConvertI32S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 135: return self.execute_f64ConvertI32U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 136: return self.execute_f64ConvertI64S(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 137: return self.execute_f64ConvertI64U(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 138: return self.execute_f32ReinterpretI32(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 139: return self.execute_f64ReinterpretI64(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 140: return self.execute_i32ReinterpretF32(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 141: return self.execute_i64ReinterpretF64(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 142: return self.execute_f32Add(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 143: return self.execute_f64Add(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 144: return self.execute_f32Sub(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 145: return self.execute_f64Sub(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 146: return self.execute_f32Mul(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 147: return self.execute_f64Mul(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 148: return self.execute_f32Div(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 149: return self.execute_f64Div(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 150: return self.execute_f32Min(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 151: return self.execute_f64Min(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 152: return self.execute_f32Max(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 153: return self.execute_f64Max(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 154: return self.execute_f32CopySign(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 155: return self.execute_f64CopySign(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 156: return self.execute_f32Eq(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 157: return self.execute_f64Eq(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 158: return self.execute_f32Ne(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 159: return self.execute_f64Ne(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 160: return self.execute_f32Lt(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 161: return self.execute_f64Lt(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 162: return self.execute_f32Gt(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 163: return self.execute_f64Gt(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 164: return self.execute_f32Le(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 165: return self.execute_f64Le(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 166: return self.execute_f32Ge(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 167: return self.execute_f64Ge(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 168: return self.execute_f32Abs(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 169: return self.execute_f64Abs(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 170: return self.execute_f32Neg(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 171: return self.execute_f64Neg(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 172: return self.execute_f32Ceil(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 173: return self.execute_f64Ceil(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 174: return self.execute_f32Floor(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 175: return self.execute_f64Floor(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 176: return self.execute_f32Trunc(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 177: return self.execute_f64Trunc(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 178: return self.execute_f32Nearest(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 179: return self.execute_f64Nearest(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 180: return self.execute_f32Sqrt(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 181: return self.execute_f64Sqrt(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 182: return self.execute_f64PromoteF32(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 183: return self.execute_f32DemoteF64(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 184: return self.execute_select(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 185: return self.execute_refNull(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 186: return self.execute_refIsNull(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 187: return self.execute_refFunc(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 188: return try self.execute_tableGet(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 189: return try self.execute_tableSet(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 190: return self.execute_tableSize(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 191: return try self.execute_tableGrow(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 192: return try self.execute_tableFill(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 193: return try self.execute_tableCopy(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 194: return try self.execute_tableInit(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 195: return self.execute_tableElementDrop(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 196: return self.execute_onEnter(sp: &sp, pc: &pc, md: &md, ms: &ms)
        case 197: return self.execute_onExit(sp: &sp, pc: &pc, md: &md, ms: &ms)
